...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="{{url('/admin/deliveries')}}"><em class="fa fa-toggle-off">&nbsp;</em> Admin Deliveries</a></li>
			<li><a href="{{url('/admin/inventory')}}"><em class="fa fa-toggle-off">&nbsp;</em> Inventory</a></li>
			...
			<li class="parent "><a data-toggle="collapse" href="#sub-item-1">
				...
				<ul class="children collapse" id="sub-item-1">
					<li><a class="" href="addproduct.html">
						<span class="fa fa-arrow-right">&nbsp;</span> Add Product
					</a></li>
					<li><a class="" href="addaccount.html">
